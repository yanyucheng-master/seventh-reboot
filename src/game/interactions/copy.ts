...
const zh: SpecialInteractionCopy = {
  ...
  power: {
    ...
    emergencyDetail: 'NOVA-06 预留的配平脚本完成了剩余分配。目标全部达成，没有人员伤亡，也没有结局惩罚。',
    reconnect: '关闭临时代理并继续',
    override: {
...
const en: SpecialInteractionCopy = {
  ...
  power: {
    ...
    emergencyDetail: "NOVA-06's stored routing profile finished the remaining allocation. Every objective was met, with no casualty or ending penalty.",
