...
const en: SpecialInteractionCopy = {
  ...
  password: {
    ...
    hints: [
      "That isn't quite right…… Give me a second. I think the key is two number pairs put together — two digits, then two more.",
      'The first pair has to do with this link. This is already the seventh one, right?',
      "The second pair is you. The system has called you Observer-01 from the start.",
      "Spaces and dashes don't matter. It only wants those four digits. Try 07… and your number.",
    ],
