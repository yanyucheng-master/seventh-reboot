...
const zh: SpecialInteractionCopy = {
  ...
  password: {
    ...
    submit: '验证密钥',
    rejected: '密钥不匹配。未触发锁定，可继续验证。',
    accepted: '联合授权成立',
    hints: [
      '提示 01：密钥由两个两位编号组成。',
      '提示 02：Nova：这次已经是第七次接入。',
      '提示 03：Nova：系统一直称你为 Observer-01。',
      '提示 04：系统建议格式 07__；空格或分隔符不会影响验证。',
    ],
  ...
  power: {
    ...
    liveMessages: {
      lowLifeSupport: 'Nova：生命维持低于安全值，先把空气循环稳住。',
      lowCommunications: 'Nova：别把通讯关掉，我需要把数据送到你那里。',
      lowCoreScan: 'Nova：扫描功率不够，数据进度停住了。',
      stable: [
        'Nova：门的结构数据出来了，扫描再维持几秒。',
        'Nova：空气循环恢复了，我正在通过低压区。',
        'Nova：数据窗口已锁定，保持住，我在发送。',
      ],
    },
...
const en: SpecialInteractionCopy = {
  ...
  password: {
    ...
    partialPlaceholder: '07__',
    submit: 'Verify key',
    rejected: 'Key mismatch. No lockout was triggered; verification remains available.',
    accepted: 'Joint authorization confirmed',
    hints: [
      'Hint 01: The key combines two two-digit identifiers.',
      'Hint 02: Nova: This is already the seventh link.',
      'Hint 03: Nova: The system has always called you Observer-01.',
      'Hint 04: System format suggestion: 07__. Spaces and separators are ignored.',
    ],
  ...
  power: {
    ...
    liveMessages: {
      lowLifeSupport: 'Nova: Life support is below the safe line. Stabilize air circulation first.',
      lowCommunications: 'Nova: Do not shut communications down. I need to send the data to you.',
      lowCoreScan: 'Nova: Scan power is too low. Data progress has stopped.',
      stable: [
        'Nova: The gate structure is resolving. Hold the scan a few more seconds.',
        'Nova: Air circulation is back. I am crossing the low-pressure section.',
        'Nova: Data window locked. Hold it there; I am transmitting.',
      ],
    },
