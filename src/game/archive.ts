...
type ArchiveDefinition = Omit<ArchiveEntry, 'unlocked'>;
...
export const ARCHIVE_ENTRIES: ArchiveDefinition[] = [
  ...
  },
  {
    ...
    title: 'N7',
    quote: '胖得像违法建筑',
    description: 'Nova 七岁时捡到的橘猫。她说自己的取名能力从小就不怎么样。',
    chapter: '第一章：连接',
    order: 20,
  },
  {
    ...
    title: '晚安',
    quote: '很高兴认识你',
    description: '第一次真正意义上的告别，不是通讯结束，而是关系开始。',
    chapter: '第一章：连接',
    order: 30,
  },
  {
    ...
    title: '观测室',
    quote: '宇宙再大，也不会回答你',
    description: 'Nova 最常停留的地方，也是她最孤独的地方。',
    chapter: '第二章：日常',
    order: 40,
  },
  {
    ...
    title: '小白花',
    quote: '明明不该活下来，却还是开了',
    description: '维修通风管里开出的花。Nova 没有上报，因为它“挺努力的”。',
    chapter: '第三章：异常',
    order: 50,
  },
  {
    ...
    description: 'Nova 童年记忆的一部分，后来成为唤醒残留情感的锚点。',
    chapter: '第二章：日常',
    order: 60,
  },
  {
    ...
    title: '宇宙级威胁',
    quote: '看，宇宙级威胁',
    description: '工程组丢失的维修板，上面被人贴了两只眼睛。',
    chapter: '第一章：连接',
    order: 70,
  },
  {
  ...
  },
  {
    ...
    description: '完整主循环次数：6\n当前循环：7\n局部回滚碎片：6412\n最终执行权限：Nova Arlen / Observer-01',
    chapter: '第五章：真相（下）',
    order: 260,
  },
  {
