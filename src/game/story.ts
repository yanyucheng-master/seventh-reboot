...
const chapter2Nodes: StoryNode[] = [
  ...
  c('ch2_obs6', [
    { text: '【你不会真喝了吧？】', nextId: 'ch2_obs_pretty', trustDelta: 1 },
  ...
  c('ch2_gn3', [
    { text: '【有这么夸张吗？】', nextId: 'ch2_gn4', trustDelta: 1 },
  ]),
...
const chapter3Nodes: StoryNode[] = [
  ...
  c('ch3_scared2', [
    { text: '【别怕】', nextId: 'ch3_scared_afraid' },
    { text: '【我在】', nextId: 'ch3_scared_here' },
    { text: '【一定有原因】', nextId: 'ch3_scared_reason' },
  ]),
  ...
  c('ch3_scared9', [
    { text: '【会】', nextId: 'ch3_scared_yes' },
    { text: '【当然】', nextId: 'ch3_scared_ofc' },
  ]),
...
const chapter4Nodes: StoryNode[] = [
  ...
  c('ch4_trust3', [
    { text: '【因为 N7？】', nextId: 'ch4_trust4' },
    { text: '【终于愿意信我了？】', nextId: 'ch4_trust_tease' },
    { text: '【你不用勉强相信的】', nextId: 'ch4_trust_gentle' },
  ]),
  ...
  c('ch4_trust12', [
    { text: '【害怕什么】', nextId: 'ch4_trust_f1' },
    { text: '【害怕想起来？】', nextId: 'ch4_trust_memory' },
    { text: '【害怕我说的是真的？】', nextId: 'ch4_trust_true' },
  ]),
  ...
  c('ch4_trust17', [
    { text: '【为什么会更难过？】', nextId: 'ch4_trust18' },
  ]),
